...
public partial class UserControls_Login : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.Cookies["DeciliDB"] != null)
            {
                string Username = Request.Cookies["DeciliDB"]["IONSUser"];
                ...
                string Password = Request.Cookies["DeciliDB"]["IONSPass"];
                if (Password != "" && Password != null)
                    txtPassword.Attributes.Add("value", Request.Cookies["DeciliDB"]["IONSPass"]);
    ...
    protected void imgBtnLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Cookies["DeciliDB"].Expires = DateTime.Now.AddDays(30);
            Response.Cookies["DeciliDB"]["IONSUser"] = txtUsername.Text;

            Response.Cookies["DeciliDB"].Expires = DateTime.Now.AddDays(30);
            Response.Cookies["DeciliDB"]["IONSPass"] = txtPassword.Text;
        }
        else
        {
            Response.Cookies["DeciliDB"].Expires = DateTime.Now.AddDays(30);
            Response.Cookies["DeciliDB"]["IONSUser"] = "";

            Response.Cookies["DeciliDB"].Expires = DateTime.Now.AddDays(30);
            Response.Cookies["DeciliDB"]["IONSPass"] = "";
        }
