...
<div class="VerMenu">
    ...
    <div class="MenuContent">
        <asp:Repeater ID="rptRootCats" runat="server">
            <ItemTemplate><div class="SubMenuCont"><div class="VMenuItem" ><asp:HyperLink NavigateUrl='<%#"~/Cats_" + Eval("Title") + "-" + Eval("Code") + CityCode + ".html" %>' runat="server"><%#ShowTitle(Eval("Title")) %><span class="arr"></span></asp:HyperLink></div></div></ItemTemplate>        </asp:Repeater>
