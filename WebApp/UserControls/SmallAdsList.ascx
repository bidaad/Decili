                        ...
                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 text-center ">
                            ...
                            <div>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"~/Ads/" + Eval("ID") + ".html" + CityCodeParam  %>'>
                                    <asp:Image CssClass="cSmallADPic" AlternateText='<%#Eval("Title") %>'  BorderWidth="1" ImageUrl='<%#"https://cdn.Decili.ir/Files/Ads/" +  DataBinder.Eval(Container.DataItem, "SmallPicFile")%>'
                                        runat="server" />
                                </asp:HyperLink>
                            </div>
                        </div>
