...
public partial class Users_EditAdvertise : System.Web.UI.Page
{
    ...
    private void LoadData(int Code)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    if (File.Exists(Server.MapPath("~/Files/Ads/" + CurAdver.LargePicFile)))
                    {
    ...
    protected void btnNewAds_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            string SaveSmallResult = PictureTools.ResizeAndSave(OrigPicPath, Server.MapPath("~/Files/Ads/") + SmallPicFirstChar + "/" + SmallPicRandName, 120);
            string SaveLargeResult = PictureTools.ResizeAndSave(OrigPicPath, Server.MapPath("~/Files/Ads/") + LargePicFirstChar + "/" + LargePicRandName, 400);
            ...
            if (SaveSmallResult == OrigPicPath)
            {
                ...
                File.Copy(OrigPicPath, Server.MapPath("~/Files/Ads/") + SmallPicFirstChar + "/" + SmallPicRandName);
            }
            ...
            {
                LargePic = LargePicFirstChar + "/" + LargePicRandName;
                File.Copy(OrigPicPath, Server.MapPath("~/Files/Ads/") + LargePicFirstChar + "/" + LargePicRandName);
            }
