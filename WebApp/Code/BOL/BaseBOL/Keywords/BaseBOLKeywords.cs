...
public class BaseBOLKeywords : Keywords, IBaseBOL<Keywords>
{
    ...
    public int Insert(string Name)
    {
        try
        {
            ...
            Decili.Code.DAL.Keywords NewKeyword = new Decili.Code.DAL.Keywords();
    ...
    int IBaseBOL.GetCount(SearchFilterCollection sFilterCols)
    {
        ...
        var ResultQuery = new Decili.Code.DAL.DBToolsDataContext().spGetCount(TableOrViewName, WhereCond);
