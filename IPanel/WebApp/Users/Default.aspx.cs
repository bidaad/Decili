    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //ltrHeaderMessage.Text += "<br />در این نوع عضویت شما حداکثر قادر به ارسال " + Tools.ChangeEnc(AllowedCarCount) + " آگهی میباشید. <a href='/Users/UpgradeMembership.aspx'>ارتقای عضویت</a>";
                //pnlMembershipMessage.Visible = true;
                //if (CurUser.HCMembershipTypeCode != 1)
                //{
                //    DateTimeMethods dtm = new DateTimeMethods();
                //    if (CurUser.MembershipExpDate != null)
                //    {
                //        strPersianExpDate = dtm.GetPersianDate((DateTime)CurUser.MembershipExpDate);
                //        ltrHeaderMessage.Text += "<br />عضویت شما تا تاریخ " + Tools.ChangeEnc(strPersianExpDate) + " معتبر میباشد";
                //    }
                //}
        ...
        protected void HandleRepeaterCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            Label lblUpdateDate = (Label)e.Item.Controls[1].FindControl("lblUpdateDate");
            ...
            if (e.CommandName == "Update")
            {
                ...
                //if (DateDiff.Days < 1)
                //if(DateTime.Now.AddDays(AddDay).CompareTo((DateTime)CurAdver.ExpDate) > 0)
                //{
                //    btnUpdate.Enabled = false;
                //    btnUpdate.Attributes["disabled"] = "disabled";
                //    msgItem.MessageTextMode = AKP.Web.Controls.Common.MessageMode.Warning;
                //    msgItem.Text = "آگهی امروز به روز رسانی شده است.";
                //    return;
                //}
                ...
                msgItem.MessageTextMode = AKP.Web.Controls.Common.MessageMode.OK;
                ...
                lblUpdateDate.Text = Tools.ChageEnc(dtm.GetPersianDate(DateTime.Now));

                AdvertisesBOL.InsertUpdate(CurAdver.Code);
