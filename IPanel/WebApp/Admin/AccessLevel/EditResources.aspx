                                                                                ...
                                                                                <td class="cFieldLeft">
                                                                                    <table class="cTblField">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="cLabel">
                                                                                                <asp:Label ID="lblName" runat="server" Text="نام فارسی:"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                <td class="cFieldRight">
                                                                                    <table class="cTblField">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="cLabel">
                                                                                                <asp:Label ID="lblEngName" runat="server" Text="نام لاتین:"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                ...
                                                                                <td class="cFieldLeft">
                                                                                    <table class="cTblField">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="cLabel">
                                                                                                <asp:Label ID="lblEditPath" runat="server" Text="مسیر:"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                ...
                                                                                <td class="cFieldLeft">
                                                                                    <table class="cTblField">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="cLabel">
                                                                                                <asp:Label ID="lblBasicAccessType" runat="server" Text="دسترسی پیش فرض:"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                <td class="cFieldRight">
                                                                                    <table class="cTblField">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="cLabel">
                                                                                                <asp:Label ID="lblResName" runat="server" Text="نام موجودیت:"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
