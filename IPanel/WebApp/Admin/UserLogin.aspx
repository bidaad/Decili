<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="Decili.Admin.UserLogin" %>
...
<body>
    ...
    <div id="wrap">
        ...
        <div class="homeLable">
            ...
            <br />
            <span id="ctl00_lblFooter2">طراحی و پیاده سازی:</span> <a href="http://Decili.com"
