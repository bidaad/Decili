<%@ Page Title="" Language="C#" MasterPageFile="~/MainRoot.Master" AutoEventWireup="true" Inherits="Ads_AdsByCatCode" CodeBehind="AdsByCatCode.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CP1" runat="Server">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
            <UC:SearchWords runat="server" ID="SearchWordsParent" />
