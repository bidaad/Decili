...
public partial class Ads_ShowAds : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (File.Exists(Server.MapPath("~/Files/Ads/" + CurAds.LargePicFile)))
                {
                    imgAdsPic.ImageUrl = "~/Files/Ads/" + CurAds.LargePicFile;
                ...
                {
                    if (File.Exists(Server.MapPath("~/Files/Ads/" + CurAds.SmallPicFile)))
                        imgAdsPic.ImageUrl = "~/Files/Ads/" + CurAds.SmallPicFile;
                    else
                        pnlPic.Visible = false;
                }
                else
