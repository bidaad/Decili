<%@ Page Language="C#" MasterPageFile="~/MainRoot.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Decili._Default" %>
...
<%@ Register Src="~/UserControls/UCProvinces.ascx" TagName="UCProvinces" TagPrefix="UC" %>
    ...
    <div class="MainDataCont">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 ">
                ...
                <UC:UCProvinces ID="UCProvinces1" runat="server" />
                <UC:UCCities ID="UCCities1" runat="server" />
                <UCAdKeywords:AdKeywords runat="server" Visible="false" ID="UCAdKeywords1" />
            </div>
